...
<body>
	...
	<div class="grid-layout">
		...
		<div style="grid-area: src_code">
			<textarea id="notepad" placeholder="drag and drop your src.xml file"></textarea>
		</div>
		...
		<div style="grid-area: dst_code">
			<textarea id="notepad2" placeholder="drag and drop your dst.xml file"></textarea>
		</div>
